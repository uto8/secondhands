module NotificationsHelper
  def notification_form(notification)
    ...
    @comment = nil
    your_item = link_to 'あなたの商品', post_path(notification), style:"font-weight: bold;"
    tag.a(notification.visiter.name, href:"", style:"font-weight: bold;")+"があなたの商品を購入しました。商品を東京都中央区銀座一丁目まで発送してください"
